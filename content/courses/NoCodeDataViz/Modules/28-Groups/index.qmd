...
For the intrepid, here is a brief, diagrammed, hand-calculated, and intuitive [walk-through of ANOVA.](https://madhatterguide.netlify.app/content/courses/analytics/20-inference/modules/130-threemeansormore/) Note that the `t-test` and `ANOVA` are identical tests, the former being used for 2-level comparisons of means, and the latter for comparisons of more than 2 means. 
...
ufo_sightings <- readr::read_csv("../../../../materials/Data/ufo_sightings.csv")
